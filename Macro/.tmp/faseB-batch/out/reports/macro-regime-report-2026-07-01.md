...
Model: CRS Rule-Based Engine v0.1-demo
Feature set: CRS Baseline v0.1-demo

## Input Summary

Data source: Imported
Data source detail: Data snapshot imported from local JSON file.
Data source reference: C:\ProgettiAzure\Codex\Macro\.tmp\faseB-batch\data\macro-data-2026-07-01.json
